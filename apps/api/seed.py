...
def seed_data():
    ...
    print("\n=== Ready for demo ===")
    print(f"Auction 1 (ID={auction1.auction_id}): {auction1.mode.value}, {auction1.area}")
    print(f"  - Status: {auction1.status.value}")
    print(f"  - Lots: {len(lots_auction1)}")
    print(f"  - Bids: {len(bids_auction1)}")
    print(f"\nAuction 2 (ID={auction2.auction_id}): {auction2.mode.value}, {auction2.area}")
    print(f"  - Status: {auction2.status.value}")
