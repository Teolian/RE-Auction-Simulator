    ...
    <div className="relative">
      ...
      >
        <div className="flex items-center gap-2">
          <span className="text-gray-600">{t('common.organization')}:</span>
        ...
        <>
          ...
          <div className="absolute right-0 top-full mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 z-20 overflow-hidden">
            <div className="px-4 py-3 border-b border-gray-100 bg-gray-50">
              <div className="text-12 text-gray-500 font-semibold uppercase tracking-wide">{t('common.selectOrganization')}</div>
            </div>
