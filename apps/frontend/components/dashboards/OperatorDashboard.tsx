                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {auction.status === 'open' && (
                      <button
                        ...
                        className="px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 font-medium text-14 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                    ...
                    {auction.status === 'locked' && (
                      <button
                        ...
                        disabled={processingAuction === auction.auction_id}
                        className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-semibold text-14 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
